...
if (timercomp ~= nil) and (entity_id ~= player_id) then
    ...
    if (is_moving == false) then
        ...
        if (timer > 80) then
            ...
            GameCreateSpriteForXFrames("mods/purgatory/files/particles/map/lvl_2/" .. map_sprite .. ".png", mi_x, mi_y, true, 0, 0, 1, true)

            --Friend
            SetRandomSeed( 24, 32 )
			local fspot = Random( 1, 6 )
			--vanilla friend spots local fspots = { { 249, 153 }, { 261, 201 }, { 153, 141 }, { 87, 135 }, { 81, 219 }, { 153, 237 } }
			--In order Frined spot 1, 2, 3, etc
            local fspots = {{369, 153}, {405, 231}, {165, 165}, {117, 129}, {75, 183}, {141, 243}}
            ...
            GameCreateSpriteForXFrames( "mods/purgatory/files/particles/map/spatial_map_friend.png", mi_x + fx, mi_y + fy, true, 0, 0, 1, true )
