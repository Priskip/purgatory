...
if (timercomp ~= nil) and (entity_id ~= player_id) then
    ...
    if (is_moving == false) then
        ...
        if (timer > 80) then
            ...
            GameCreateSpriteForXFrames("mods/purgatory/files/particles/map/lvl_1/" .. map_sprite .. ".png", mi_x, mi_y, true, 0, 0, 1, true)
            GameCreateSpriteForXFrames("mods/purgatory/files/particles/map/spatial_map_player.png", pi_x, pi_y, true, 0, 0, 1, true)
            --
            ...
            for i, offset in ipairs(num_positions) do
                ...
                GameCreateSpriteForXFrames( "mods/purgatory/files/particles/map/pw_nums/pw_num_"..num_name..".png", mi_x + 9 + 6 * offset, mi_y - 82, true, 0, 0, 1, true )
            end
        end
    else
        timer = 0
