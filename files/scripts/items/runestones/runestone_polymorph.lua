...
EntityLoad( "mods/purgatory/files/entities/misc/runestone_polymorph.xml", x, y )
...
if ( #projectiles > 0 ) then
	for i,projectile_id in ipairs( projectiles ) do
		...
		if ( tags == nil ) or ( string.find( tags, "orb_poly" ) == nil ) then
			...
			shoot_projectile_from_projectile( projectile_id, "data/entities/projectiles/orb_poly.xml", px, py, vel_x, vel_y )
