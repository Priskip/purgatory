...
function item_pickup( entity_item, entity_who_picked, name )
	...
	local physics_comp = EntityGetFirstComponentIncludingDisabled(entity_item, "PhysicsThrowableComponent")
	ComponentSetValue(physics_comp, "max_throw_speed", "90")
	ComponentSetValue(physics_comp, "throw_force_coeff", "3")
end
