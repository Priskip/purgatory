...
ComponentSetValue2(sprite_comp, "image_file", "mods/purgatory/files/items_gfx/starting_wand_yellow.xml")
ComponentSetValue2(ability_comp, "sprite_file", "mods/purgatory/files/items_gfx/starting_wand_yellow.xml")
