...
ComponentSetValue2(sprite_comp, "image_file", "mods/purgatory/files/items_gfx/starting_wand_red.xml")
ComponentSetValue2(ability_comp, "sprite_file", "mods/purgatory/files/items_gfx/starting_wand_red.xml")

local hotspot_comp = EntityGetFirstComponentIncludingDisabled(entity_id, "HotspotComponent") --Get HotspotComponent
ComponentSetValueVector2(hotspot_comp, "offset", 6, -0.5)
