...
function init(x, y, w, h)
	LoadPixelScene("mods/purgatory/files/biome_impl/debug/empty_material.png", "mods/purgatory/files/biome_impl/debug/empty_visual.png", x, y, "mods/purgatory/files/biome_impl/debug/spawn_platform_background.png", true)
end
