...
function init( x, y, w, h )
	LoadPixelScene(
        "mods/purgatory/files/biome_impl/alchemist_arena/arena_left.png",
        "mods/purgatory/files/biome_impl/alchemist_arena/arena_left_visual.png",
        x, y,
        "mods/purgatory/files/biome_impl/alchemist_arena/arena_left_background.png",
        true
    )
end
