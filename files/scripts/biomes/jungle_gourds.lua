...
function init( x, y, w, h )
	LoadPixelScene( "mods/purgatory/files/biome_impl/jungle_gourds/jungle_gourds.png", "", x, y, "mods/purgatory/files/biome_impl/jungle_gourds/jungle_gourds_background.png", true )
end
