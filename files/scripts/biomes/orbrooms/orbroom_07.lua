...
function init( x, y, w, h )
	...
	--EntityLoad( "data/entities/misc/orb_07_pitcheck_b.xml", x - 64, y + 256 ) --Pit boss spawning logic is moved to a custom wand in pitboss arena
end
...
function spawn_orb(x, y)
	...
	--EntityLoad( "data/entities/misc/orb_07_pitcheck_a.xml", x, y ) --Pit boss spawning logic is moved to a custom wand in pitboss arena
