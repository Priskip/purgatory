...
function init( x, y, w, h )
    LoadPixelScene( "mods/purgatory/files/biome_impl/forge_biome.png", "mods/purgatory/files/biome_impl/forge_biome_visual.png", x, y, "mods/purgatory/files/biome_impl/forge_biome_background.png", true )
end
