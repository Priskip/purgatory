...
function init( x, y, w, h )
    ...
    LoadPixelScene( "mods/purgatory/files/biome_impl/boss_limbs.png", "mods/purgatory/files/biome_impl/boss_limbs_visual.png", x, y, "mods/purgatory/files/biome_impl/boss_limbs_background.png", true )
end
