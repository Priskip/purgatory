...
if cauldron_sucker.queue.string ~= "" then
    ...
    local has_material_needed_to_push = is_in_table(cauldron_sucker.materials, material_to_push)
    ...
    if has_material_needed_to_push then
        ...
        variable_storage_set_value(drain_ent, "STRING", "material_and_amount", material_to_push)
        variable_storage_set_value(drain_ent, "INT", "material_and_amount", tonumber(cauldron_sucker.amounts[find_element_in_table(cauldron_sucker.materials, material_to_push)]))
        variable_storage_set_value(drain_ent, "INT", "material_type", cauldron_sucker.mode)
