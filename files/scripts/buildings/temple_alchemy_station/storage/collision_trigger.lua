...
function collision_trigger(colliding_entity)
    ...
    if storage_ent.mode == "place" then
        ...
        elseif holding_powder_stash then
            ...
            ComponentSetValue2(storage_ent.interact_comp, "ui_text", "$storage_interact_placing_invalid_item")
        end
    end
    ...
    if storage_ent.mode == "pick_up" then
        ...
        if #getHeldItems() < 4 then
            ...
            local display_text =
                GameTextGetTranslatedOrNot("$storage_pickup_part_1") ..
                potion_display_name .. GameTextGetTranslatedOrNot("$storage_pickup_part_2_" .. stored_potion.potion_or_sack) .. percent_filled .. GameTextGetTranslatedOrNot("$storage_pickup_part_3")
            ...
            ComponentSetValue2(storage_ent.interact_comp, "ui_text", "$storage_collision_trigger_inventory_full_" .. stored_potion.potion_or_sack)
        end
    end
end
