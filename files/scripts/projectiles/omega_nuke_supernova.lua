...
local has_supernovaed = GameHasFlagRun("supernova_has_happened_in_current_run")

if not has_supernovaed then
    GameAddFlagRun("supernova_has_happened_in_current_run")
