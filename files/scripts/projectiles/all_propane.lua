...
if ( #projectiles > 0 ) then
	for i,projectile_id in ipairs( projectiles ) do
		...
		if ( tags == nil ) or ( string.find( tags, "propane" ) == nil ) then
			...
			shoot_projectile_from_projectile( projectile_id, "data/entities/projectiles/propane_tank.xml", px, py, vel_x, vel_y )
