...
variable_storage_set_value(entity_id, "FLOAT", "power_level", power_level)
        ...
        if (not EntityHasTag(projectile_id, "death_cross_bigger")) then
            ...
            if (distance < absorbtion_distance) then
                ...
                if damage > 0 then
                    ...
                    variable_storage_set_value(entity_id, "FLOAT", "stored_damage", stored_damage)
                end
                ...
                if damage_by_types_have_change then
                    ...
                    variable_storage_set_value(entity_id, "STRING", "stored_damage_by_type", stored_damage_by_type_string)
                end

                --Increment Projectiles Absorbed
                projectiles_absorbed = projectiles_absorbed + 1
                variable_storage_set_value(entity_id, "INT", "projectiles_absorbed", projectiles_absorbed)
