...
shoot_projectile(entity_id, "mods/purgatory/files/entities/animals/boss_pit/wand_of_shielding/shield_shot_large.xml", ent_x + spawn_offset, ent_y, vel_x, vel_y, true)
