...
--[[
	...
	Shuffle				No
	Spells/Cast			1
	Cast Delay			0.5s +/- 5/60
	Recharge Time		1s +/- 5/60
	Mana Max			2000 +/- 250
	Mana Charge Speed	250 +/- 100
	Capicity			25
	Spread				0
	Speed				1
]]
...
gun.fire_rate_wait = {25,65}
gun.reload_time = {55,65}
gun.mana_max = {1750, 2250}
gun.mana_charge_speed = {150, 350}
gun.deck_capacity = 25
gun.spread_degrees = 0
gun.speed_multiplier = 1.0

gun.actions = {"DESTRUCTION"}
...
AddGunActionPermanent(entity_id, "WORLD_EATER")
