...
biome_modifiers =
{
	...
	-- {
	-- 	id = "PRISKIP",
	-- 	ui_description = "$biomemodifierdesc_priskip",
	-- 	ui_decoration_file = "mods/purgatory/files/ui_gfx/decorations_biome_modifier/priskip.png",
	-- 	probability = 0.0,
	-- 	action = function(biome_name, biome_filename)
	-- 		--Need to use ModImageMakeEditable before calling this
	-- 		local id, w, h = ModImageIdFromFilename("data/wang_tiles/excavationsite.png")
	...
	-- 				if color == water_color then
	-- 					ModImageSetPixel(id, x, y, midas_color)
	-- 				end
	-- 			end
	-- 		end
	-- 	end,
...
function get_modifier_mappings()
	...
	--Priskip testing:
	--Force custom biome mod onto coal pits if it doesn't have one already
	--set_modifier_if_has_none("excavationsite", "PRISKIP")
