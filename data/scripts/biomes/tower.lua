...
g_pixel_scene_02 = {
	...
	--[[
	--( Petri ): Disabled the other wand traps for now, to test if this box2d electricty based wand trap is even a good idea
	{
		prob   			= 1.5,
...
function spawn_big_enemies(x, y, w, h, is_open_path)
	...
	--Spawn Spell with Big Enemy
	EntityLoad("mods/purgatory/files/entities/items/tower_spell_shop_spell.xml", x, y)
end
