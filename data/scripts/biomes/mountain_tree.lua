...
function spawn_pillars(x, y)
	...
	SetRandomSeed(x, y)
	local flags = {
		--Persistance Flag Name, Pillar PNG Name
		{
		...
		{
			{"purgatory_win", "purgatory_win"},
			{"purgatory_win_no_edit_start", "purgatory_win_no_edit_start"},
			{"purgatory_great_chest_sac", "purgatory_great_chest_sac"},
			{"purgatory_omega_nuke", "purgatory_omega_nuke"}
		},
		{
	...
	for i = 1, count do
		...
		if i ~= 4 then
			--Load Vanilla tree achieve pillar
			for j = 1, under do
			...
			--Load purgatory tree achieve pillar
			for j = 1, under do
				LoadPixelScene("data/biome_impl/pillars/pillar_part_material.png", "", px, py, "mods/purgatory/files/biome_impl/pillars/pillar_part.png", true)
				py = py + size
			end

			LoadPixelScene("data/biome_impl/pillars/pillar_part_material.png", "", px, py, "mods/purgatory/files/biome_impl/pillars/pillar_fade.png", true)
		end
		...
		if i ~= 4 then
			...
			for j, v in ipairs(data) do
				...
				if valid then
					py = py - size
					LoadPixelScene("data/biome_impl/pillars/pillar_part_material.png", "", px, py, "mods/purgatory/files/biome_impl/pillars/" .. v[2] .. ".png", true)
				end
			end

			py = py - size

			LoadPixelScene("data/biome_impl/pillars/pillar_part_material.png", "", px, py, "mods/purgatory/files/biome_impl/pillars/pillar_top.png", true)
		end
	end
end
