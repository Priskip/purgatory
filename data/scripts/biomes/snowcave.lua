...
-- NOTE PRISKIP: I am overwriting this file to have Suur Ukko spawn in new game
...
g_big_enemies =
{
	...
	{
		prob   		= 0.04, --originally 0.08
		min_count	= 1,
		max_count	= 1,
		--ngpluslevel	= 1, --Remove NG+ Requirement for Suur Ukko to spawn
		entity 	= "data/entities/animals/thundermage_big.xml"
	},
	{
		prob   		= 0.05,
