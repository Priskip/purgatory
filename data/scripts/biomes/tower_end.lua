...
function spawn_essence(x, y)
	EntityLoad( "data/entities/items/wands/wand_good/wand_good_1.xml", x - 20, y + 12 ) --swiftness
	EntityLoad( "data/entities/items/wands/wand_good/wand_good_2.xml", x, y + 12 ) --destruction
	EntityLoad( "data/entities/items/wands/wand_good/wand_good_3.xml", x + 20, y + 12 ) --multitudes
