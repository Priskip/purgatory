...
function collision_trigger()
	...
	--PURGATORY
	local alchemy_station_ents = EntityGetInRadiusWithTag( pos_x - 1044, pos_y + 44, 240, "temple_alchemy_station" )
	if alchemy_station_ents ~= nil then
		for i, ent in ipairs (alchemy_station_ents) do
			EntityKill(ent)
		end
	end

	LoadPixelScene(
		"mods/purgatory/files/biome_impl/temple/altar_left_collapsed.png",
		"mods/purgatory/files/biome_impl/temple/altar_left_collapsed_visual.png",
		pos_x - 1164,
		pos_y - 53,
		"mods/purgatory/files/biome_impl/temple/altar_left_collapsed_background.png",
		true
	)
end