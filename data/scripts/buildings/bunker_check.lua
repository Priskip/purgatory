...
if ( #p > 0 ) and GameHasFlagRun( "fishing_hut_a" ) then
	...
	CreateItemActionEntity( "COLOUR_WHITE", x + 104, y - 13)
	CreateItemActionEntity( "COLOUR_BLACK", x + 116, y - 14)
	CreateItemActionEntity( "COLOUR_RANDOM", x + 128, y - 15)
	CreateItemActionEntity( "COLOUR_RAINBOW", x + 140, y - 16)
	CreateItemActionEntity( "COLOUR_INVIS", x + 152, y - 17)
