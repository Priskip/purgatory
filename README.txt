...
This mod aims to improve the nightmare mode experience by adding all the stuff from normal mode into a nightmare environment. It also adds new stuff and expands on some things I felt like are missing in the base game.
